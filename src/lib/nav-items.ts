...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Unassigned', href: '/unassigned', module: PermissionModule.ORDERS },
  { label: 'Refunds', href: '/refunds', module: PermissionModule.PAYMENTS },
  ...
  { label: 'Dispatch', href: '/dispatch', module: PermissionModule.PRICING },
